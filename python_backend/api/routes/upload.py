from fastapi import APIRouter, UploadFile, File, HTTPException, BackgroundTasks, Request, Form, Depends
...
async def get_upload_status(
    ...
    """Get processing status for a job — requires admin | academic_advisor"""
